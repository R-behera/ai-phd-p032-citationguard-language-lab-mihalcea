...
This repository is currently a **research proposal and execution scaffold**, not a completed result. Use it to show Professor Mihalcea that you understand the research area and can contribute a concrete, reproducible artifact.
...
- **Research area from CSV:** NLP, computational social science, multimodal
- **Representative paper from CSV:** TextRank: Bringing Order into Texts; 2004; EMNLP
