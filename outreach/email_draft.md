...
Dear Professor Mihalcea,

I am preparing for Fall 2027 PhD applications and have been studying your work around **NLP, computational social science, multimodal**. I was especially interested in the direction represented by **TextRank: Bringing Order into Texts; 2004; EMNLP**.

I put together a small research scaffold for a project I would like to develop further: **ClaimTrace RAG Lab: NLP for Mihalcea-Aligned Research**. The goal is to build **a citation-faithful RAG and evaluation harness for advisor-domain papers** focused on **NLP**, with reproducible baselines, ablations, and failure analysis rather than a demo-only implementation.
...
Project summary: https://github.com/R-behera/ai-phd-p032-citationguard-language-lab-mihalcea
...
Public repo URL: https://github.com/R-behera/ai-phd-p032-citationguard-language-lab-mihalcea
