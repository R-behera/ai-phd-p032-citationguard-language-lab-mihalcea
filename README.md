# ClaimTrace RAG Lab: NLP for Mihalcea-Aligned Research

A professor-outreach research proposal aligned with **Rada Mihalcea** at **University of Michigan**.
...
This repo has its own runnable prototype method: **MihalceaConstraintNlpRouteEngine**.
...
How can a focused, reproducible artifact around **NLP** create useful research infrastructure for a lab working on **NLP, computational social science, multimodal**?
...
- **CSV research area:** NLP, computational social science, multimodal
- **Representative paper:** TextRank: Bringing Order into Texts; 2004; EMNLP
- **Scholar link:** https://scholar.google.com/scholar?q=TextRank%3A+Bringing+Order+into+Texts
