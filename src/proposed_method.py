...
METHOD_SPEC = {
    "algorithm_id": "P032-Mihalcea-Nlp",
    "algorithm_name": "MihalceaConstraintNlpRouteEngine",
    ...
    "decision_rule": "Rank seed cases by language-specific priority score with Mihalcea-aligned focus term 'NLP'.",
