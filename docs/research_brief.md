...
CitationGuard Language Lab: NLP for Mihalcea-Aligned Research

## Motivation

This project targets the intersection of **NLP, computational social science, multimodal** and PhD-level research readiness. The goal is to produce a publishable-style artifact with a clear claim, reproducible experiments, and an honest account of failures.
...
2. Add one measurable method or evaluation contribution tied to Rada Mihalcea's research area.
...
Advisor-specific slice: **NLP, computational social science, multimodal**.
